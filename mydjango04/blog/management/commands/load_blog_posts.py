...
def create_posts(orig_post_list):
    ...
    if post_list:
        ...
        if connection.vendor != 'mysql':
            ...
            # MySQL에서는 INSERT 쿼리 시에 추가된 id 값을 반환할 수 없습니다.
            # 관련 질문: https://www.inflearn.com/questions/1319557/07-33-%EB%8D%B0%EC%9D%B4%ED%84%B0-%EB%A1%9C%EB%93%9C-%EC%97%90%EB%9F%AC
            try:
            ...
            new_post_list = Post.objects.filter(id__gt=max_id).order_by('id')
            assert len(new_post_list) == len(post_list)
